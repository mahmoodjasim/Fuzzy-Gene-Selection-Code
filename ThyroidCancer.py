...
import pandas as pd
data5 = pd.read_csv("C:/Users/Mahmood/Desktop/Camparsion/thyroid/Microarray/Orginalthyroid.csv")


# In[2]:


data2= data5.drop('Samples', axis=1)
...
data3.to_csv(r'C:/Users/Mahmood/Desktop/Camparsion/thyroid/Microarray/FuzzyGenes.csv')
...
import pandas as pd
data4 = pd.read_csv("C:/Users/Mahmood/Desktop/Camparsion/thyroid/Microarray/FuzzyGenes.csv")
