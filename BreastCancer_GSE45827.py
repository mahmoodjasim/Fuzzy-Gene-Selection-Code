...
import pandas as pd
data2 = pd.read_csv("C:/Users/Mahmood/Desktop/Camparsion/BreastCancer/Microarray/Microarray/155SamplesBreastCancerSubtypes1.csv")
...
data = data2.drop('Class', axis=1)#independent columns
...
data3.to_csv(r'C:/Users/Mahmood/Desktop/Camparsion/BreastCancer/Microarray/FuzzyGeneSelected_Breastcancer/FuzzyGenes.csv')
